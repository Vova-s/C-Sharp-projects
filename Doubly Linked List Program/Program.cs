...
namespace Doubly_Linked_List_Program
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                WriteLine("9. Exit");
                Write("Input the number of the action you want to perform on the list: ");
                ...
                else if (n == 4)
                {
                    ...
                    Write("Input element: ");
                    el = int.Parse(ReadLine());
                    list.AddToPosition(el.ToString(), number);
                    WriteLine();
                    WriteLine("*********************************************");
                    list.Print();
                    WriteLine();
                ...
                {
                    Clear();
                    WriteLine("Add a new node after the middle node if there's an even number of nodes, otherwise in front of the head of the list");
                    Write("Input element: ");
                    el = int.Parse(ReadLine());
                    WriteLine();
